...
import {
  ChevronLeft, ChevronRight, Bookmark, BookmarkCheck, Search,
  User, Home as HomeIcon, BarChart3, RotateCcw, Volume2, Check, X, Mic,
...
/* =========================================================
   ROOT
========================================================= */
export default function LexoraPrototype() {
  useFonts();
...
createRoot(rootEl).render(React.createElement(LexoraPrototype));
